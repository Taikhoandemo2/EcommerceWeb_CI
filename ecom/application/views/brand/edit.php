...
if ($this->session->flashdata('success'))
  ...
  <div class="form-group">
    ...
    <input type="text" value="<?php echo $brand->title?>" name="title" value="<?php echo $brand->title?>" class="form-control" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp" >
    <?php echo '<span class="text text-danger">'.form_error('title').'</span>';?>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Slug</label>
    <input type="text"  value="<?php echo $brand->slug?>" name="slug" value="<?php echo $brand->slug?>" class="form-control" id="convert_slug" aria-describedby="emailHelp" >
